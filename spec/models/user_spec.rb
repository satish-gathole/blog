...
describe User do
  ...
  before do
    @user = User.new(username: "tester", email: "testre@example.com", password: "password", password_confirmation: "password", active: true)
  end
  ...
  describe "post associations" do
    ...
    describe "status" do
      ...
      let(:followed_user) { FactoryGirl.create(:user, username: 'followed', email: 'followed@example.com') }
